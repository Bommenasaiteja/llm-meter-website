      ...
      <div className="w-full md:my-auto">
        <div className="relative flex items-center justify-between">
          <Link href={siteConfig.baseLinks.home} aria-label="Home">
            <span className="sr-only">LLM Meter Logo</span>
          ...
          <nav className="hidden sm:block md:absolute md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2 md:transform">
            <div className="flex items-center gap-10 font-medium">
              ...
              <Link className="px-2 py-1 text-gray-900" href="/docs">
                Docs
              </Link>
            </div>
          </nav>
          ...
          >
              <Link className="px-2 py-1 text-gray-900" href="https://github.com/Bommenasaiteja/llm-meter-backend">
                GitHub
              </Link>
          </Button>
          <Button
        ...
        >
          <ul className="space-y-4 font-medium">
            ...
            <li onClick={() => setOpen(false)}>
              <Link href="https://github.com/Bommenasaiteja/llm-meter-backend">GitHub</Link>
            </li>
          </ul>
