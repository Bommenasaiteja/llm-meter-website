    ...
    <section aria-label="hero">
      <FadeContainer className="relative flex flex-col items-center justify-center">
        ...
        <h1 className="mt-8 text-center text-5xl font-semibold tracking-tighter text-gray-900 sm:text-8xl sm:leading-22">
          <FadeSpan>Track</FadeSpan> <FadeSpan>and</FadeSpan>
          <br />
          <FadeSpan>Monitor</FadeSpan> <FadeSpan>LLM</FadeSpan>
        </h1>
        <p className="mt-5 max-w-xl text-center text-base text-balance text-gray-700 sm:mt-8 sm:text-xl">
          <FadeSpan>Revolutionize your LLM usage with comprehensive</FadeSpan>{" "}
          <FadeSpan>analytics, cost monitoring, and performance</FadeSpan>{" "}
          <FadeSpan>tracking across multiple AI providers.</FadeSpan>
        </p>
        <FadeDiv>
          <a
            ...
            href="https://github.com/Bommenasaiteja/llm-meter-backend"
          >
            Get Started
          </a>
        </FadeDiv>
