  ...
  const sections = {
    solutions: {
      ...
      items: [
        ...
        { label: "Multi-Provider Support", href: "#" },
      ],
    },
    partners: {
      title: "Connect",
      items: [
        { label: "GitHub", href: "https://github.com/Bommenasaiteja/llm-meter-backend", external: true },
        { label: "CLI Documentation", href: "/docs/cli" },
      ],
    },
  }
      ...
      >
        ...
        <div className="mr-auto flex w-full justify-between lg:w-fit lg:flex-col">
          ...
          >
            ...
            <span className="sr-only">LLM Meter Logo (go home)</span>
          </Link>
        </div>
