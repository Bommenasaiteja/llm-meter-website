...
export default function Features() {
  return (
    <section
      aria-label="LLM Meter Features for AI Usage Tracking"
      id="solutions"
      ...
      <div className="grid grid-cols-1 gap-12 md:grid-cols-4 md:gap-0">
        ...
        <div className="col-span-2 my-auto px-2">
          ...
          <p className="mt-2 text-3xl font-semibold tracking-tighter text-balance text-gray-900 md:text-4xl">
            Comprehensive tracking of your LLM usage and costs
          </p>
          <p className="mt-4 text-balance text-gray-700">
            Monitor token usage, costs, and performance metrics across multiple
            AI providers like OpenAI, Anthropic, Ollama, and more with detailed
            ...
            <div className="relative flex flex-col items-center justify-center">
              <Orbit
                ...
                orbitingObjects={[
                  ...
                  >
                    <RiBarChartFill className="z-10 size-5 text-gray-900" />
                    ...
                    <div className="absolute -top-5 left-4">
                      <div className="flex gap-1">
                        <div className="flex items-center justify-center rounded-l-full bg-red-500 p-1 text-xs ring-1 ring-gray-200">
                          <RiGlobeLine className="size-3 shrink-0 text-white" />
                        </div>
                  ...
                  <div
                    ...
                    className="relative flex items-center justify-center"
                  >
                    <RiServerFill className="z-10 size-5 rotate-90 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-black/5"></div>
                    <div className="absolute -top-5 left-4">
                      <div className="flex gap-1">
                        <div className="flex items-center justify-center rounded-l-full bg-gray-500 p-1 text-xs ring-1 ring-gray-200">
                          <RiServerFill className="size-3 shrink-0 text-white" />
                        </div>
                  ...
                  <div
                    ...
                    className="relative flex items-center justify-center"
                  >
                    <RiCodeLine className="z-10 size-5 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-black/5"></div>
                    <div
                      style={{
                        animationDelay: "2s",
                  ...
                  <div
                    ...
                    className="relative flex items-center justify-center"
                  >
                    <RiTerminalWindowLine className="z-10 size-5 rotate-90 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-black/5"></div>
                    <div className="absolute -top-5 left-4">
                      <div className="flex gap-1">
                        <div className="flex items-center justify-center rounded-l-full bg-emerald-500 p-1 text-xs ring-1 ring-gray-200">
                          <RiBarChartFill className="size-3 shrink-0 text-white" />
                        </div>
                        <div className="rounded-r-full bg-white/50 py-0.5 pr-1.5 pl-1 text-xs ring-1 ring-gray-200">
                          Analytics
                        </div>
                  ...
                  <div
                    ...
                    className="relative flex items-center justify-center"
                  >
                    <RiSettings3Line className="z-10 size-5 rotate-90 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-black/5"></div>
                    <div
                      style={{
                        animationDelay: "3s",
        ...
        <div className="col-span-2 my-auto px-2">
          ...
          <p className="mt-2 text-3xl font-semibold tracking-tighter text-balance text-gray-900 md:text-4xl">
            Track usage across OpenAI, Anthropic, Ollama, and more
          </p>
          <p className="mt-4 text-balance text-gray-700">
            Unified dashboard for monitoring all your AI providers. Track costs,
            tokens, and performance metrics in one place for better visibility
        ...
        <div className="col-span-2 my-auto px-2">
          ...
          <p className="mt-2 text-3xl font-semibold tracking-tighter text-balance text-gray-900 md:text-4xl">
            Command-line interface and API for seamless integration
          </p>
          <p className="mt-4 text-balance text-gray-700">
            Access your usage data via the LLM Meter CLI or REST API to
            integrate with your development workflow and monitoring systems.
          </p>
        </div>
        <div className="relative col-span-2 flex items-center justify-center overflow-hidden">
          <svg
